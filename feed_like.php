...
<head>
    ...
    <title>Понравившиеся посты</title> <script src="https://cdn.tailwindcss.com"></script>
...
<main class="w-full md:w-2/3 lg:w-1/2 border-x border-gray-800 min-h-screen">
    <header class="sticky top-0 bg-gray-900 bg-opacity-80 backdrop-blur-sm p-4 border-b border-gray-800 flex justify-between">
        <h1 class="text-xl font-bold">Понравившиеся посты</h1> <div>Привет, <?=htmlspecialchars($_SESSION["username"])?> | <a href="logout.php" class="text-blue-500">Выйти</a></div>
    </header>
